const Footer = () => {
  return (
    <footer className="bg-background">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-lg mx-4 md:mx-8 lg:mx-16 mb-8 overflow-hidden">
        <div className="grid lg:grid-cols-2">
          {/* Company Information - Dark Section */}
          <div className="bg-black text-white p-8 lg:p-12">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p>+46 76 976 82 63</p>
              <p className="text-gray-400 mt-6">Copyright 2022. All Rights Reserved.</p>
            </div>
          </div>
