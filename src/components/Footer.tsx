const Footer = () => {
  return (
    <footer className="bg-background">
      {/* Main Footer Section with Contact Form */}
      <div className="bg-background/60 border border-border rounded-lg shadow-sm mx-4 md:mx-8 lg:mx-16 mb-8 overflow-hidden">
        <div className="grid lg:grid-cols-2">
          {/* Company Information - Inverted block matching theme */}
          <div className="bg-foreground text-background p-8 lg:p-12">
            <h3 className="text-xl font-bold mb-6">Main Branch</h3>
            <div className="space-y-3 text-sm">
              ...
              <p>+46 76 976 82 63</p>
              <p className="text-muted-foreground mt-6">Copyright 2022. All Rights Reserved.</p>
            </div>
          </div>
          ...
          <div className="bg-background p-8 lg:p-12">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-background py-3 px-6 rounded-md hover:opacity-95 transition-colors font-medium"
              >
                Send Message
              </button>
            </form>
      ...
      <div className="bg-foreground text-background py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            {/* India Branch */}
            <div>
              <h4 className="text-lg font-semibold mb-4">India Branch</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4">Battery Lab Facility</h4>
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>iGraph Technologies Pvt Ltd</p>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="p-2 bg-foreground/10 hover:bg-foreground/20 rounded-lg transition-colors">
